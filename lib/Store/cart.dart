...
class _CartPageState extends State<CartPage>
{
            ...
            child: Consumer2<TotalAmount,CartItemCounter>(builder: (context,amountProvider,cartProvider,c)
            {
              return Padding(
                ...
                /*child: Center(
                  ...
                  ? Container()
                  : Text(
                    "Total Price : Rs. ${amountProvider.display(totalAmount).toString()}",
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("Cart is empty..."),
              Text("Start adding item to the cart..."),
            ],
          ),
        ),
      ),
  ...
  removeItemFromUserCart(String shotInfoAsId){
    List tempCartList=EcommerceApp.sharedPreferences.getStringList(EcommerceApp.userCartList);
    tempCartList.remove(shotInfoAsId);
