          ...
          Container(
            ...
            decoration: new BoxDecoration(
              gradient: new LinearGradient(
                colors: [Colors.blue[800],Colors.white70],
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                ListTile(
                  leading: Icon(Icons.reorder_sharp,color: Colors.white,),
                ...
                ListTile(
                  leading: Icon(Icons.local_grocery_store_outlined,color: Colors.white,),
